...
public enum NationalityEnum {
    ...
    public static List<Map<String,Object>> getNationalityList() {
        Map<String,Object> map = new HashMap<>();
        List<Map<String,Object>> mapList = new ArrayList<>();
        NationalityEnum[] nationalityEnums = values();
        for (int i = 0; i < nationalityEnums.length; i++) {
            NationalityEnum nationalityEnum = nationalityEnums[i];
            map.put("code",nationalityEnum.getCode());
            map.put("name",nationalityEnum.getDesc());
            mapList.add(map);
            map = new HashMap<>();
        }
        List<Map<String, Object>> mapList1 = ListCountry.removeRepeatMapByKey(mapList, "code");
        return mapList1;
    }
